 ...
 *
 * Prerequisites:
 *   - Account already exists in Firebase Auth (kobet@parrishhealthsystems.org)
 *   - service-account.json in project root (or GOOGLE_APPLICATION_CREDENTIALS set)
 *
 * Usage:
 *   npx tsx scripts/seed/provisionKobet.ts
 */
...
// ── User to provision ─────────────────────────────
const USER = {
  email: 'kobet@parrishhealthsystems.org',
  displayName: 'Kobet',
  role: 'admin' as const,
